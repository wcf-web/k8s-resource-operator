...
// ServiceControlSpec defines the desired state of ServiceControl
type ServiceControlSpec struct {
...
// ServiceControl is the Schema for the servicecontrols API
type ServiceControl struct {
	metav1.TypeMeta   `json:",inline"`
	metav1.ObjectMeta `json:"metadata,omitempty"`

	Spec   ServiceControlSpec   `json:"spec,omitempty"`
	Status ServiceControlStatus `json:"status,omitempty"`
}

//+kubebuilder:object:root=true

// ServiceControlList contains a list of ServiceControl
...
func init() {
	SchemeBuilder.Register(&ServiceControl{}, &ServiceControlList{})
}
